...
@section('title', 'Notificaciones - Macero')
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-6 flex justify-between items-center">
            ...
            <a href="{{ route('vocero.dashboard') }}" class="bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white font-bold py-2 px-4 rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-2">
...
<script>
    ...
    function markAsRead(id) {
        fetch(`/vocero/notificaciones/${id}/marcar-leida`, {
            method: 'POST',
            headers: {
    ...
    function markAllAsRead() {
        if (confirm('¿Marcar todas las notificaciones como leídas?')) {
            fetch('/vocero/notificaciones/marcar-todas-leidas', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
