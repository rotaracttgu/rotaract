        ...
        <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-blue-500 hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-blue-600">{{ $totalProyectos ?? 0 }}</h3>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-green-500 hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-green-600">{{ $proyectosActivos ?? 0 }}</h3>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-orange-500 hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-orange-600">{{ $cartasPendientes ?? 0 }}</h3>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-purple-500 hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-purple-600">{{ $reunionesHoy ?? 0 }}</h3>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="space-y-4">
            <div class="bg-white rounded-lg shadow-md p-4 border border-gray-100">
                ...
                <div class="space-y-2">
                    <a href="{{ route('admin.presidente.estado.proyectos') }}" class="flex items-center p-3 bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 rounded-lg hover:from-blue-100 hover:to-blue-200 transition-all duration-200 shadow-sm group">
                    ...
                    <a href="{{ route('admin.presidente.cartas.patrocinio') }}" class="flex items-center p-3 bg-gradient-to-r from-orange-50 to-orange-100 text-orange-700 rounded-lg hover:from-orange-100 hover:to-orange-200 transition-all duration-200 shadow-sm group">
                    ...
                    <a href="{{ route('admin.presidente.cartas.formales') }}" class="flex items-center p-3 bg-gradient-to-r from-green-50 to-green-100 text-green-700 rounded-lg hover:from-green-100 hover:to-green-200 transition-all duration-200 shadow-sm group">
