        ...
        <div class="bg-gradient-to-br from-orange-600 to-orange-800 rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-all duration-200">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-4xl font-black text-white">{{ $pendientes ?? 8 }}</p>
        ...
        <div class="bg-gradient-to-br from-purple-600 to-purple-800 rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-all duration-200">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-4xl font-black text-white">{{ $nuevosEsteMes ?? 4 }}</p>
        ...
        <div class="bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-all duration-200">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-4xl font-black text-white">{{ $eventosHoy ?? 9 }}</p>
        ...
        <div class="bg-gradient-to-br from-cyan-600 to-cyan-800 rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-all duration-200">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-4xl font-black text-white">{{ $loginsHoy ?? 4 }}</p>
        ...
        <div class="bg-gradient-to-br from-red-600 to-red-800 rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-all duration-200">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-4xl font-black text-white">{{ $erroresHoy ?? 0 }}</p>
        ...
        <div class="bg-gradient-to-br from-gray-700 to-gray-900 rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-all duration-200">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-4xl font-black text-white">{{ $totalEventos ?? 390 }}</p>
...
<div class="bg-gray-800 rounded-2xl shadow-xl p-6">
    ...
    <div class="space-y-3">
        ...
        <div class="flex items-center space-x-4">
            <div class="w-32">
                <span class="text-sm font-semibold text-gray-300">{{ $rol['nombre'] }}</span>
            </div>
            <div class="flex-1">
                <div class="flex items-center space-x-2">
                    <div class="flex-1 bg-gray-700 rounded-full h-3">
                        <div class="bg-{{ $rol['color'] }}-500 h-3 rounded-full transition-all duration-500" style="width: {{ $rol['porcentaje'] }}%"></div>
                    </div>
                    <span class="text-sm font-bold text-gray-300 w-12 text-right">{{ $rol['cantidad'] }}</span>
                    <span class="text-xs text-gray-500 w-16 text-right">{{ $rol['porcentaje'] }}%</span>
                </div>
            </div>
        </div>
        @endforeach
                ...
                <tr class="hover:bg-gray-700/50 transition-colors">
                    <td class="px-4 py-3">
                        <div class="flex items-center">
                            ...
                            <span class="ml-3 text-sm font-semibold text-gray-200">{{ $usuario['nombre'] }}</span>
                        </div>
                    </td>
                    <td class="px-4 py-3">
                    ...
                    <td class="px-4 py-3">
                        <span class="text-sm text-gray-400">{{ $usuario['actividad'] }}</span>
                    </td>
