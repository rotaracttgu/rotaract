<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('aspirante.dashboard') }}" class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded flex items-center gap-2">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 mb-6">
                <div class="flex flex-wrap gap-4 items-center justify-between">
                    <div class="flex gap-3">
                        ...
                        <button onclick="filterNotifications('proyectos')" class="px-4 py-2 rounded-lg font-medium transition filter-btn" data-filter="proyectos">
                            Proyectos
                        </button>
                        <button onclick="filterNotifications('reuniones')" class="px-4 py-2 rounded-lg font-medium transition filter-btn" data-filter="reuniones">
                            Reuniones
                        </button>
                        <button onclick="filterNotifications('actividades')" class="px-4 py-2 rounded-lg font-medium transition filter-btn" data-filter="actividades">
                            Actividades
                        </button>
                    </div>
