        ...
        <div class="relative top-20 mx-auto p-0 border-0 w-11/12 md:w-3/4 lg:w-1/2 shadow-2xl rounded-xl bg-white">
            ...
            <form id="formResponderConsulta" onsubmit="enviarRespuesta(event)" class="p-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="respuesta" rows="6" required class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 focus:outline-none" placeholder="Escribe tu respuesta aquí..."></textarea>
                </div>
