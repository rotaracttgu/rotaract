...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-purple-500 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-start justify-between gap-2">
                <div class="flex-1 min-w-0">
                    <p class="text-xs sm:text-sm text-gray-500 uppercase tracking-wide mb-2 font-semibold truncate">CONSULTAS PENDIENTES</p>
                    <h3 class="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent">{{ $consultasPendientes ?? 0 }}</h3>
                </div>
                <div class="bg-gradient-to-br from-purple-500 to-purple-600 p-2 sm:p-3 rounded-xl shadow-md flex-shrink-0">
        ...
        <!-- Total Actas -->
        <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-sky-500 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-start justify-between gap-2">
                <div class="flex-1 min-w-0">
                    <p class="text-xs sm:text-sm text-gray-500 uppercase tracking-wide mb-2 font-semibold truncate">TOTAL ACTAS</p>
                    <h3 class="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-sky-600 to-sky-800 bg-clip-text text-transparent">{{ $estadisticas['total_actas'] ?? 0 }}</h3>
                </div>
                <div class="bg-gradient-to-br from-sky-500 to-sky-600 p-2 sm:p-3 rounded-xl shadow-md flex-shrink-0">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Total Diplomas -->
        <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-amber-500 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-start justify-between gap-2">
                <div class="flex-1 min-w-0">
                    <p class="text-xs sm:text-sm text-gray-500 uppercase tracking-wide mb-2 font-semibold truncate">DIPLOMAS EMITIDOS</p>
                    <h3 class="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-amber-600 to-amber-800 bg-clip-text text-transparent">{{ $estadisticas['total_diplomas'] ?? 0 }}</h3>
                </div>
                <div class="bg-gradient-to-br from-amber-500 to-amber-600 p-2 sm:p-3 rounded-xl shadow-md flex-shrink-0">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-emerald-500 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-start justify-between gap-2">
                <div class="flex-1 min-w-0">
                    <p class="text-xs sm:text-sm text-gray-500 uppercase tracking-wide mb-2 font-semibold truncate">DOCUMENTOS</p>
                    <h3 class="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-emerald-600 to-emerald-800 bg-clip-text text-transparent">{{ $estadisticas['total_documentos'] ?? 0 }}</h3>
                </div>
