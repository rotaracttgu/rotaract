    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 mb-6">
        <div class="flex flex-wrap gap-4 items-center justify-between">
            <div class="flex gap-3">
                ...
                <button onclick="filterNotifications('cartas')" class="px-4 py-2 rounded-lg font-medium transition filter-btn" data-filter="cartas">
                    Cartas
                </button>
            </div>
                    ...
                    <div class="notification-item p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition cursor-pointer {{ $notificacion->leida ? 'bg-gray-50' : 'bg-blue-50 border-blue-200' }}" 
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-shrink-0">
                                ...
                                @elseif($notificacion->tipo == 'cartas')
