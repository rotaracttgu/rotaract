...
<div class="container-fluid px-4 py-4">
    ...
    <div class="create-header">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <p class="mb-0 opacity-90">Complete la información de la transferencia</p>
            </div>
        </div>
    </div>
    ...
    <div class="info-box">
        ...
        <strong>Nota:</strong> La transferencia generará dos movimientos: una salida de la cuenta origen y una entrada en la cuenta destino.
        Si hay comisión, se registrará como un gasto adicional.
    </div>

    <!-- Formulario -->
    <form action="{{ route('tesorero.transferencias.store') }}" method="POST" enctype="multipart/form-data" id="formTransferencia">
        @csrf
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('tipo_transferencia') is-invalid @enderror" 
                        ...
                        @foreach($tipos_transferencia as $valor => $descripcion)
                            <option value="{{ $valor }}" {{ old('tipo_transferencia') == $valor ? 'selected' : '' }}>
                                {{ $descripcion }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('metodo') is-invalid @enderror" 
                        ...
                        @foreach($metodos as $metodo)
                            <option value="{{ $metodo }}" {{ old('metodo') == $metodo ? 'selected' : '' }}>
                                {{ $metodo }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('numero_referencia', 'TRF-' . date('Y') . '-' . strtoupper(substr(uniqid(), -6))) }}"
                               readonly
            ...
            <div class="row">
                <div class="col-md-5 mb-3">
                    ...
                    <select class="form-select @error('cuenta_origen') is-invalid @enderror" 
                        ...
                        @foreach($cuentas as $cuenta)
                            <option value="{{ $cuenta }}" {{ old('cuenta_origen') == $cuenta ? 'selected' : '' }}>
                                {{ $cuenta }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-5 mb-3">
                    ...
                    <select class="form-select @error('cuenta_destino') is-invalid @enderror" 
                        ...
                        @foreach($cuentas as $cuenta)
                            <option value="{{ $cuenta }}" {{ old('cuenta_destino') == $cuenta ? 'selected' : '' }}>
                                {{ $cuenta }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="alert alert-info">
                        ...
                        <span id="montoTotal">L. 0.00</span>
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('notas') is-invalid @enderror" 
                              ...
                              rows="3"
                              maxlength="500"
                              placeholder="Información adicional sobre la transferencia...">{{ old('notas') }}</textarea>
                    @error('notas')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
        ...
        <div class="row">
            <div class="col-12 text-end">
                ...
                <button type="submit" class="btn btn-submit">
                    <i class="fas fa-save me-2"></i>Registrar Transferencia
                </button>
            </div>
        </div>
