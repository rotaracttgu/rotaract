    ...
    <div class="mb-6 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-xl p-6 shadow-lg text-white">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('presidente.usuarios.crear') }}" 
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @php
                                    $roleColors = [
                                        ...
                                        'presidente' => 'from-blue-500 to-cyan-600',
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    <a href="{{ route('presidente.usuarios.ver', $usuario->id) }}" 
                                    ...
                                    <form action="{{ route('presidente.usuarios.eliminar', $usuario->id) }}" 
                                        method="POST" 
                                        class="inline-block"
