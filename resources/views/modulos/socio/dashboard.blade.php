...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-green-500 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-start justify-between gap-2">
                <div class="flex-1 min-w-0">
                    <p class="text-xs sm:text-sm text-gray-500 uppercase tracking-wide mb-2 font-semibold truncate">PRÓXIMAS REUNIONES</p>
                    <h3 class="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">{{ $reunionesProgramadas ?? 0 }}</h3>
                    <p class="text-xs text-green-600 mt-2 truncate">Programadas / {{ $totalReuniones ?? 0 }} total</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-orange-500 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-start justify-between gap-2">
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-baseline flex-wrap gap-1">
                        <h3 class="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-orange-600 to-orange-800 bg-clip-text text-transparent">{{ $consultasPendientes ?? 0 }}</h3>
                        <span class="text-xs sm:text-sm text-gray-500">/ {{ $totalConsultas ?? 0 }}</span>
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-purple-500 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-start justify-between gap-2">
                <div class="flex-1 min-w-0">
                    <p class="text-xs sm:text-sm text-gray-500 uppercase tracking-wide mb-2 font-semibold truncate">MIS NOTAS</p>
                    <h3 class="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent">{{ $totalNotas ?? 0 }}</h3>
                    <p class="text-xs text-purple-600 mt-2 truncate">{{ $notasPrivadas ?? 0 }} privadas, {{ $notasPublicas ?? 0 }} públicas</p>
                </div>
