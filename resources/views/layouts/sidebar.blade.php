        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            ...
            <div x-data="{ open: false }" class="mb-2">
                ...
                <div x-show="open" x-collapse class="mt-2 ml-4 space-y-1">
                    <a href="{{ route('presidente.dashboard') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-gray-800 transition-colors {{ request()->routeIs('presidente.dashboard') ? 'bg-purple-600' : '' }}">
