...
@section('header')
    <div class="flex justify-between items-center">
        ...
        <div class="flex items-center space-x-3">
            <div class="text-sm text-gray-700 bg-white px-5 py-2.5 rounded-full shadow-sm border border-gray-200">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-red-500 via-red-600 to-pink-600 p-6 text-white shadow-2xl transform hover:scale-105 transition-all duration-300 min-h-[180px] flex flex-col justify-between">
                    <div class="absolute top-0 right-0 -mt-4 -mr-4 h-24 w-24 rounded-full bg-white/20 blur-2xl"></div>
                    <div class="relative">
                        <div class="flex items-start justify-between">
                            <div>
                                <p class="text-red-100 text-xs font-semibold uppercase tracking-wider mb-2">🔒 Bloqueados</p>
                                <p class="text-5xl font-black text-white">{{ $usuariosBloqueados->total() }}</p>
                            </div>
                    ...
                    <div class="relative">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-5xl font-black text-white">{{ $usuariosConIntentos->total() }}</p>
                            </div>
                            <div class="bg-white rounded-2xl p-3">
                    ...
                    <div class="relative">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-5xl font-black text-white">{{ \App\Models\Parametro::obtener('max_intentos_login', 3) }}</p>
                            </div>
                            <div class="bg-white rounded-2xl p-3">
                    ...
                    <div class="relative">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-5xl font-black text-white">{{ \App\Models\Parametro::obtener('tiempo_bloqueo_minutos', 30) }}</p>
                            </div>
                            <div class="bg-white rounded-2xl p-3">
            ...
            <div class="mb-10 overflow-hidden rounded-3xl bg-white shadow-2xl border border-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($usuariosBloqueados as $usuario)
                                    <tr class="hover:bg-gray-50 transition-all duration-200 group">
                                        ...
                                        <td class="px-6 py-5 whitespace-nowrap">
                                            <span class="inline-flex items-center px-3 py-1.5 rounded-xl text-xs font-bold bg-red-100 text-red-800">
                                        ...
                                        <td class="px-6 py-5 whitespace-nowrap">
                                            ...
                                            @if($minutosRestantes > 0)
                                                <span class="inline-flex items-center px-3 py-1.5 rounded-xl text-xs font-bold bg-red-100 text-red-800 animate-pulse">
                                                    <svg class="w-3.5 h-3.5 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                                            ...
                                            @else
                                                <span class="inline-flex items-center px-3 py-1.5 rounded-xl text-xs font-bold bg-green-100 text-green-800">
                                                    <svg class="w-3.5 h-3.5 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="overflow-hidden rounded-3xl bg-white shadow-2xl border border-gray-200">
                <div class="bg-white px-8 py-6 border-b border-gray-200">
                    <h3 class="text-2xl font-bold text-gray-900 flex items-center">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($usuariosConIntentos as $usuario)
                                    <tr class="hover:bg-gray-50 transition-all duration-200 group">
                                        ...
                                        <td class="px-6 py-5 whitespace-nowrap">
                                            <span class="inline-flex items-center px-3 py-1.5 rounded-xl text-xs font-bold bg-amber-100 text-amber-800">
                                                <svg class="w-3.5 h-3.5 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
