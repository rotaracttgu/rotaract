...
$sql = <<<'SQL'
CREATE DEFINER=`dbadmin`@`localhost` PROCEDURE `SP_MisReuniones`(IN `p_user_id` BIGINT, IN `p_tipo_filtro` VARCHAR(50), IN `p_tipo_evento` VARCHAR(50))
BEGIN
...
DB::statement("DROP PROCEDURE IF EXISTS SP_MisReuniones");
DB::statement($sql);

echo "✅ SP_MisReuniones corregido\n";
