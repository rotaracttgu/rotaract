...
// Script para crear el SP_ResponderConsulta
// Este script crea el stored procedure para responder consultas
...
DB::statement($sql);
echo "✓ Stored Procedure SP_ResponderConsulta creado exitosamente\n";
?>
