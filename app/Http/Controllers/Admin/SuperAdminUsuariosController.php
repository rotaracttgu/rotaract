...
class SuperAdminUsuariosController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            if ($request->has('buscar') && $request->filled('buscar')) {
                ...
                return view('modulos.superadmin.usuarios.index', [
            ...
            return view('modulos.superadmin.usuarios.index', compact('usuarios', 'totalUsuarios', 'estadisticas'));
    ...
    {
        return view('modulos.superadmin.usuarios.create');
    }
    ...
    public function show($usuario)
    {
        ...
        return view('modulos.superadmin.usuarios.ver', compact('usuario'));
    }
    ...
    public function edit($usuario)
    {
        // Buscar el usuario por ID
        $usuario = User::findOrFail($usuario);
        return view('modulos.superadmin.usuarios.edit', compact('usuario'));
    }
