...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'gestiones_clubrotario'),
        ...
        'source' => [
            ...
            /*
             * ⭐ CONFIGURACIÓN ACTUALIZADA PARA MYSQL CON XAMPP
             * Solo ponemos el nombre de la conexión, la configuración va en config/database.php
             */
            'databases' => [
                'mysql',
            ],
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => 'backup_gestiones_',
