...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_Calendario_Aspirante`(IN `p_user_id` BIGINT, IN `p_mes` INT, IN `p_anio` INT, IN `p_tipo_evento` VARCHAR(50))
BEGIN
