        ...
        <div class="bg-gradient-to-r from-gray-800 to-gray-900 px-6 py-4 border-b border-gray-700">
            <div class="flex justify-between items-center">
                <h6 class="text-xl font-bold text-white flex items-center mb-0">
                    <i class="fas fa-list mr-3 text-purple-400"></i>Lista de Roles (<?php echo e($roles->total()); ?>)
                </h6>
                <div class="text-gray-400">
                    <small>Mostrando <?php echo e($roles->firstItem() ?? 0); ?> - <?php echo e($roles->lastItem() ?? 0); ?> de <?php echo e($roles->total()); ?></small>
                </div>
            </div>
        </div>
                    ...
                    <tbody class="bg-gray-800/30 divide-y divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-700/50 transition-colors duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-gray-400 font-medium"><?php echo e($roles->firstItem() + $index); ?></span>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="font-bold text-white"><?php echo e($role->name); ?></span>
                                        <?php if(in_array($role->name, ['Super Admin', 'Presidente', 'Vicepresidente', 'Tesorero', 'Secretario', 'Vocero'])): ?>
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-700 text-gray-300"><?php echo e($role->guard_name); ?></span>
                            </td>
                            ...
                            <td class="px-6 py-4 text-center">
                                <?php if(in_array($role->name, ['Super Admin', 'Presidente', 'Vicepresidente', 'Tesorero', 'Secretario', 'Vocero', 'Aspirante'])): ?>
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <button onclick="verDetallesRol(<?php echo e($role->id); ?>)"
                                    ...
                                    <button onclick="asignarPermisos(<?php echo e($role->id); ?>)"
                                    ...
                                    <?php if($role->name !== 'Super Admin'): ?>
                                        <button onclick="editarRol(<?php echo e($role->id); ?>)"
                                        ...
                                        <?php if(!in_array($role->name, ['Presidente', 'Vicepresidente', 'Tesorero', 'Secretario', 'Vocero', 'Aspirante'])): ?>
                                            <button type="button" 
                                                    ...
                                                    title="Eliminar"
                                                    onclick="eliminarRol(<?php echo e($role->id); ?>, '<?php echo e(addslashes($role->name)); ?>')">
        ...
        <div class="bg-gray-800/50 px-6 py-4 border-t border-gray-700">
            <div class="flex justify-between items-center">
                <div class="text-gray-400 text-sm">
                    Mostrando <?php echo e($roles->firstItem() ?? 0); ?> a <?php echo e($roles->lastItem() ?? 0); ?> de <?php echo e($roles->total()); ?> resultados
                </div>
...
function cargarFormularioCrear() {
    cargarContenidoAjax('<?php echo e(route("admin.configuracion.roles.create")); ?>', '#config-content');
}

function verDetallesRol(roleId) {
    cargarContenidoAjax(`<?php echo e(url('admin/configuracion/roles')); ?>/${roleId}`, '#config-content');
}

function editarRol(roleId) {
    cargarContenidoAjax(`<?php echo e(url('admin/configuracion/roles')); ?>/${roleId}/edit`, '#config-content');
}

function asignarPermisos(roleId) {
    cargarContenidoAjax(`<?php echo e(url('admin/configuracion/roles')); ?>/${roleId}/asignar-permisos`, '#config-content');
}
...
function eliminarRol(roleId, roleName) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: `<?php echo e(url('admin/configuracion/roles')); ?>/${roleId}`,
                method: 'DELETE',
                headers: {
...
<?php endif; ?>
<?php echo $__env->make('layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Carlo\Desktop\Club Rotaract-Web Service\Rotaract_Diseño_Web\Rotaract\rotaract\resources\views/modulos/admin/configuracion/roles/index.blade.php ENDPATH**/ ?>