...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="font-sans antialiased">
        ...
        <?php if(auth()->check() && auth()->user()->hasRole('Tesorero')): ?>
        <script>
...
<?php /**PATH C:\Users\Carlo\Desktop\Club Rotaract-Web Service\Rotaract_Diseño_Web\Rotaract\rotaract\resources\views/layouts/app.blade.php ENDPATH**/ ?>