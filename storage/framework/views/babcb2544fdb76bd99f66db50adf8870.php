...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel')); ?> - Super Admin</title>
        ...
        <?php if(isset($header)): ?>
            <header class="bg-white shadow-sm mb-4">
                <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                    <h1 class="h5 mb-0 text-gray-800"><?php echo e($header); ?></h1>
                </div>
            </header>
        <?php endif; ?>
...
</html><?php /**PATH C:\Users\Carlo\Desktop\Club Rotaract-Web Service\Rotaract_Diseño_Web\Rotaract\rotaract\resources\views/layouts/app-admin.blade.php ENDPATH**/ ?>