    ...
    <div class="flex justify-between items-center p-6 bg-gradient-to-br from-gray-900 to-indigo-950 text-white shadow-2xl">
        ...
        <div class="flex items-center space-x-4">
            <div class="text-sm font-medium text-gray-300 bg-gray-800 px-5 py-2.5 rounded-full shadow-md border border-gray-700">
                <span class="text-purple-300 font-bold"><?php echo e($totalUsuarios ?? 0); ?></span> <?php echo e($totalUsuarios === 1 ? 'usuario' : 'usuarios'); ?>

            </div>
            <a href="<?php echo e(route(($moduloActual ?? 'admin') . '.usuarios.crear')); ?>" 
...
<?php $__env->startSection('content'); ?>
    <div class="min-h-screen bg-gradient-to-br from-gray-900 to-indigo-950 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="config-content" class="mb-6">
                <!-- Por defecto muestra la gestión de usuarios, AJAX cargará aquí Roles/Permisos -->
                    ...
                    <div class="mb-8 rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-700 p-5 shadow-xl transform hover:scale-[1.02] transition-all duration-300 animate-fade-in">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <?php if(session('usuario_creado')): ?>
                                    <p class="mt-1 text-sm text-white/90">Usuario "<?php echo e(session('usuario_creado')); ?>" creado correctamente.</p>
                                <?php elseif(session('usuario_actualizado')): ?>
                                    <p class="mt-1 text-sm text-white/90">Usuario "<?php echo e(session('usuario_actualizado')); ?>" actualizado correctamente.</p>
                                <?php elseif(session('usuario_eliminado')): ?>
                                    <p class="mt-1 text-sm text-white/90">Usuario "<?php echo e(session('usuario_eliminado')); ?>" eliminado correctamente.</p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8 rounded-2xl bg-gradient-to-r from-red-600 to-pink-700 p-5 shadow-xl transform hover:scale-[1.02] transition-all duration-300">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="mt-1 text-sm text-white/90"><?php echo e($error); ?></p>
                            </div>
                        </div>
                    </div>
                <?php else: ?>
                            ...
                            <div class="relative">
                                <div class="flex items-start justify-between">
                                    <div>
                                        ...
                                        <p class="text-4xl font-bold text-white"><?php echo e($totalUsuarios); ?></p>
                                    </div>
                            ...
                            <div class="relative">
                                <div class="flex items-start justify-between">
                                    <div class="w-full">
                                        ...
                                        <p class="text-xl font-bold text-white truncate"><?php echo e(config('database.connections.mysql.database')); ?></p>
                                    </div>
                                    <div class="bg-white/20 rounded-full p-3">
                    ...
                    <div class="bg-gray-800 rounded-2xl shadow-xl overflow-hidden ring-1 ring-gray-700/50">
                                ...
                                <tbody class="bg-gray-800 divide-y divide-gray-700">
                                    ...
                                    <tr class="hover:bg-gray-700 transition-all duration-200">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-sm font-bold text-gray-200">#<?php echo e($usuario->id); ?></span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <?php $userDisplay = $usuario->username ?? $usuario->nombre_completo; ?>
                                            <div class="flex items-center">
                                                <div class="h-11 w-11 rounded-full bg-gradient-to-br from-pink-600 via-purple-600 to-indigo-700 flex items-center justify-center text-white text-sm font-bold shadow-md">
                                                    <?php echo e(strtoupper(substr($userDisplay, 0, 2))); ?>

                                                </div>
                                                <div class="ml-4">
                                                    <div class="text-sm font-bold text-gray-200"><?php echo e($usuario->username ?? $usuario->name); ?></div>
                                                    <?php if($usuario->username): ?>
                                                        <div class="text-xs text-gray-400"><?php echo e($usuario->nombre_completo); ?></div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-400"><?php echo e($usuario->email); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-3 py-1 inline-flex text-xs leading-5 font-bold rounded-full bg-purple-900/50 text-purple-200">
                                                <?php echo e($usuario->getRolPrincipal() ?? 'Sin rol'); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <div class="flex items-center justify-center space-x-2">
                                                <!-- Botón Editar -->
                                                <a href="<?php echo e(route(($moduloActual ?? 'admin') . '.usuarios.editar', $usuario)); ?>" 
                                                ...
                                                <!-- Botón Ver -->
                                                <a href="<?php echo e(route(($moduloActual ?? 'admin') . '.usuarios.ver', $usuario)); ?>" 
                        ...
                        <!-- Paginación -->
                        <?php if(isset($usuarios) && $usuarios->hasPages()): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Carlo\Desktop\Club Rotaract-Web Service\Rotaract_Diseño_Web\Rotaract\rotaract\resources\views/modulos/users/index.blade.php ENDPATH**/ ?>