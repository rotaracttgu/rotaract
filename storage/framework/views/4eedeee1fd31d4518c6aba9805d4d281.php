<?php $__env->startSection('header'); ?>
    <div class="flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4">
            ...
            <!-- Botón de Eliminar -->
            <form method="POST" action="<?php echo e(route(($moduloActual ?? 'admin') . '.usuarios.eliminar', $usuario)); ?>" 
                  onsubmit="return confirm('¿Está seguro de que desea eliminar al usuario <?php echo e($usuario->name); ?>? Esta acción no se puede deshacer.');">
                <?php echo csrf_field(); ?>
            ...
            <div class="overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-black/5">
                ...
                <div class="bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 px-8 py-10">
                    <div class="text-center">
                        ...
                        <h3 class="mt-4 text-3xl font-black text-white"><?php echo e($usuario->name); ?></h3>
                        <div class="mt-2 flex items-center justify-center space-x-4 text-white/90">
                            ...
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold bg-white/20">
                                ...
                                Registrado: <?php echo e($usuario->created_at->format('d/m/Y')); ?>
                ...
                <div class="px-8 py-10">
                    <form method="POST" action="<?php echo e(route(($moduloActual ?? 'admin') . '.usuarios.actualizar', $usuario)); ?>" class="space-y-8" id="formEditarUsuario" onsubmit="return validarFormulario('formEditarUsuario')">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    value="<?php echo e(old('rotary_id', $usuario->rotary_id)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="group">
                            ...
                            <input id="fecha_juramentacion" name="fecha_juramentacion" type="date"
                                ...
                                value="<?php echo e(old('fecha_juramentacion', $usuario->fecha_juramentacion?->format('Y-m-d'))); ?>">
                        </div>
                        ...
                        <div class="group">
                            ...
                            <input id="fecha_cumpleaños" name="fecha_cumpleaños" type="date"
                                class="block w-full px-4 py-4 text-base border-2 border-gray-300 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200" 
                                value="<?php echo e(old('fecha_cumpleaños', $usuario->fecha_cumpleaños?->format('Y-m-d'))); ?>">
                        </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input id="contrasena" name="password" type="password" 
                                            class="block w-full pl-12 pr-4 py-4 text-base border-2 border-gray-300 rounded-2xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 bg-red-50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> appearance-none bg-white cursor-pointer">
                                    ...
                                    <option value="Super Admin" <?php echo e(old('role', $usuario->role) == 'Super Admin' ? 'selected' : ''); ?>>🔐 Super Admin</option>
                                    <option value="Presidente" <?php echo e(old('role', $usuario->role) == 'Presidente' ? 'selected' : ''); ?>>👑 Presidente</option>
                                    <option value="Vicepresidente" <?php echo e(old('role', $usuario->role) == 'Vicepresidente' ? 'selected' : ''); ?>>👔 Vicepresidente</option>
                                    <option value="Tesorero" <?php echo e(old('role', $usuario->role) == 'Tesorero' ? 'selected' : ''); ?>>💰 Tesorero</option>
                                    <option value="Secretario" <?php echo e(old('role', $usuario->role) == 'Secretario' ? 'selected' : ''); ?>>📝 Secretario</option>
                                    <option value="Vocero" <?php echo e(old('role', $usuario->role) == 'Vocero' ? 'selected' : ''); ?>>📢 Vocero</option>
                                    <option value="Aspirante" <?php echo e(old('role', $usuario->role) == 'Aspirante' ? 'selected' : ''); ?>>⭐ Aspirante</option>
                                </select>
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-6">
                                    ...
                                    <input id="correo_verificado" name="email_verified" value="1" type="checkbox" 
                                        ...
                                        <?php echo e(old('email_verified', $usuario->email_verified_at ? true : false) ? 'checked' : ''); ?>>
                                </div>
                                <div class="ml-4">
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">
                                        <?php if($usuario->email_verified_at): ?>
                                            Verificado el <?php echo e($usuario->email_verified_at->format('d/m/Y H:i')); ?>
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-6">
                                    ...
                                    <input id="two_factor_verified" name="two_factor_verified" value="1" type="checkbox" 
                                        class="h-5 w-5 text-purple-600 border-gray-300 rounded focus:ring-purple-500 focus:ring-2 cursor-pointer" 
                                        <?php echo e(old('two_factor_verified', $usuario->two_factor_verified_at ? true : false) ? 'checked' : ''); ?>>
                                </div>
                                <div class="ml-4">
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">
                                        <?php if($usuario->two_factor_verified_at): ?>
                                            Verificado el <?php echo e($usuario->two_factor_verified_at->format('d/m/Y H:i')); ?>
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-6">
                                    ...
                                    <input id="activo" name="activo" value="1" type="checkbox" 
                                        ...
                                        <?php echo e(old('activo', $usuario->activo ?? true) ? 'checked' : ''); ?>>
                                </div>
                                <div class="ml-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Carlo\Desktop\Club Rotaract-Web Service\Rotaract_Diseño_Web\Rotaract\rotaract\resources\views/modulos/users/edit.blade.php ENDPATH**/ ?>