    ...
    <div class="login-wrapper">
        <div class="login-container">
            ...
            <div class="logo-container">
                <img src="<?php echo e(asset('images/LogoRotaract.png')); ?>" alt="Rotaract Club Tegucigalpa Sur">
            </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="password-recovery-section">
                    ...
                    <div class="recovery-options">
                        <a href="<?php echo e(route('password.request')); ?>" class="recovery-option email">
                            <svg class="recovery-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            Por Email
                        </a>
                        <a href="<?php echo e(route('password.security.identify')); ?>" class="recovery-option questions">
                            <svg class="recovery-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if(Route::has('register')): ?>
                    <div class="register-link">
                        Don't have an account? <a href="<?php echo e(route('register')); ?>">Sign up here</a>
                    </div>
                <?php endif; ?>
            </form>
        </div>
...
<?php /**PATH C:\Users\Carlo\Desktop\Club Rotaract-Web Service\Rotaract_Diseño_Web\Rotaract\rotaract\resources\views/auth/login.blade.php ENDPATH**/ ?>