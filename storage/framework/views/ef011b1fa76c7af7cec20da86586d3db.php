...
<?php $__env->startSection('content'); ?>
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('admin.presidente.dashboard')); ?>" class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded flex items-center gap-2">
        ...
        <div class="w-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 overflow-hidden shadow-lg sm:rounded-lg p-4 cursor-pointer hover:shadow-xl transition-all transform hover:scale-105" onclick="filtrarPorEstadoProyecto('')">
                    ...
                    <p class="text-3xl font-bold text-white"><?php echo e($estadisticas['total']); ?></p>
                ...
                <div class="bg-gradient-to-br from-yellow-500 to-yellow-600 overflow-hidden shadow-lg sm:rounded-lg p-4 cursor-pointer hover:shadow-xl transition-all transform hover:scale-105" onclick="filtrarPorEstadoProyecto('Planificacion')">
                    ...
                    <p class="text-3xl font-bold text-white"><?php echo e($estadisticas['enPlanificacion']); ?></p>
                ...
                <div class="bg-gradient-to-br from-blue-500 to-blue-600 overflow-hidden shadow-lg sm:rounded-lg p-4 cursor-pointer hover:shadow-xl transition-all transform hover:scale-105" onclick="filtrarPorEstadoProyecto('EnEjecucion')">
                    ...
                    <p class="text-3xl font-bold text-white"><?php echo e($estadisticas['enEjecucion']); ?></p>
                ...
                <div class="bg-gradient-to-br from-green-500 to-green-600 overflow-hidden shadow-lg sm:rounded-lg p-4 cursor-pointer hover:shadow-xl transition-all transform hover:scale-105" onclick="filtrarPorEstadoProyecto('Finalizado')">
                    ...
                    <p class="text-3xl font-bold text-white"><?php echo e($estadisticas['finalizados']); ?></p>
                ...
                <div class="bg-gradient-to-br from-red-500 to-red-600 overflow-hidden shadow-lg sm:rounded-lg p-4 cursor-pointer hover:shadow-xl transition-all transform hover:scale-105" onclick="filtrarPorEstadoProyecto('Cancelado')">
                    ...
                    <p class="text-3xl font-bold text-white"><?php echo e($estadisticas['cancelados']); ?></p>
                    ...
                    <div id="gridView" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <?php $__empty_1 = true; $__currentLoopData = $proyectos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proyecto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="bg-white border border-gray-200 rounded-lg p-5 hover:shadow-lg transition-shadow proyecto-card" 
                                 ...
                                 data-area="<?php echo e($proyecto->TipoProyecto); ?>">
                                <div class="flex justify-between items-start mb-3">
                                    <div class="flex-1">
                                        <h4 class="font-semibold text-gray-800 mb-1"><?php echo e($proyecto->Nombre); ?></h4>
                                        <span class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e($estadoClass); ?>">
                                            <?php if($estado == 'EnEjecucion'): ?>
                                                En Ejecución
                                            <?php elseif($estado == 'Planificacion'): ?>
                                                Planificación
                                            <?php else: ?>
                                                <?php echo e($estado); ?>
                                ...
                                <p class="text-sm text-gray-600 mb-4"><?php echo e(Str::limit($proyecto->Descripcion ?? 'Sin descripción', 80)); ?></p>
                            
                                <div class="space-y-2 text-xs mb-4">
                                    <div class="flex justify-between">
                                        <span class="text-gray-500">Tipo:</span>
                                        <span class="font-medium text-gray-700"><?php echo e($proyecto->TipoProyecto ?? 'N/A'); ?></span>
                                    </div>
                                    <?php if($proyecto->FechaInicio): ?>
                                        <div class="flex justify-between">
                                            <span class="text-gray-500">Inicio:</span>
                                            <span class="font-medium text-gray-700"><?php echo e(\Carbon\Carbon::parse($proyecto->FechaInicio)->format('d/m/Y')); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($proyecto->FechaFin): ?>
                                        <div class="flex justify-between">
                                            <span class="text-gray-500"><?php echo e($estado == 'Finalizado' ? 'Finalizado:' : 'Fin previsto:'); ?></span>
                                            <span class="font-medium text-gray-700"><?php echo e(\Carbon\Carbon::parse($proyecto->FechaFin)->format('d/m/Y')); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <div class="flex justify-between">
                                        <span class="text-gray-500">Presupuesto:</span>
                                        <span class="font-medium text-green-700">L. <?php echo e(number_format($proyecto->Presupuesto ?? 0, 2)); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="flex justify-between text-xs text-gray-600 mb-1">
                                        <span>Progreso</span>
                                        <span class="font-semibold"><?php echo e($progreso); ?>%</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-2.5">
                                        <div class="<?php echo e($progressColor); ?> h-2.5 rounded-full" style="width: <?php echo e($progreso); ?>%"></div>
                                    </div>
                                </div>

                                <div class="flex gap-2">
                                    <button class="flex-1 text-center text-sm text-indigo-600 hover:text-indigo-800 font-medium border border-indigo-200 rounded py-2 hover:bg-indigo-50 transition" onclick="verDetalleProyecto(<?php echo e($proyecto->ProyectoID); ?>)">
                                        Ver detalles
                                    </button>
                                    <button class="text-sm text-yellow-600 hover:text-yellow-800 font-medium border border-yellow-200 rounded px-3 py-2 hover:bg-yellow-50 transition" onclick="editarProyecto(<?php echo e($proyecto->ProyectoID); ?>)" title="Editar">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                        </svg>
                                    </button>
                                    <button class="text-sm text-red-600 hover:text-red-800 font-medium border border-red-200 rounded px-3 py-2 hover:bg-red-50 transition" onclick="eliminarProyecto(<?php echo e($proyecto->ProyectoID); ?>)" title="Eliminar">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__empty_1 = true; $__currentLoopData = $proyectos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proyecto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr class="hover:bg-gray-50" 
                                        data-estado="<?php echo e($estadoTabla); ?>" 
                                        data-area="<?php echo e($proyecto->TipoProyecto); ?>">
                                        <td class="px-6 py-4">
                                            <div>
                                                <p class="text-sm font-medium text-gray-900"><?php echo e($proyecto->Nombre); ?></p>
                                                <p class="text-xs text-gray-500">
                                                    <?php if($proyecto->FechaInicio && $proyecto->FechaFin): ?>
                                                        <?php echo e(\Carbon\Carbon::parse($proyecto->FechaInicio)->format('d/m/Y')); ?> - <?php echo e(\Carbon\Carbon::parse($proyecto->FechaFin)->format('d/m/Y')); ?>

                                                    <?php elseif($proyecto->FechaInicio): ?>
                                                        Desde <?php echo e(\Carbon\Carbon::parse($proyecto->FechaInicio)->format('d/m/Y')); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($proyecto->TipoProyecto ?? 'N/A'); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($estadoClass); ?>">
                                                <?php if($estadoTabla == 'EnEjecucion'): ?>
                                                    En Ejecución
                                                <?php elseif($estadoTabla == 'Planificacion'): ?>
                                                    Planificación
                                                <?php else: ?>
                                                    <?php echo e($estadoTabla); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="w-24">
                                                <div class="text-xs text-gray-600 mb-1"><?php echo e($progreso); ?>%</div>
                                                <div class="w-full bg-gray-200 rounded-full h-2">
                                                    <div class="<?php echo e($progressColor); ?> h-2 rounded-full" style="width: <?php echo e($progreso); ?>%"></div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">L. <?php echo e(number_format($proyecto->Presupuesto ?? 0, 2)); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                            <button class="text-indigo-600 hover:text-indigo-900" onclick="verDetalleProyecto(<?php echo e($proyecto->ProyectoID); ?>)">Ver</button>
                                            <button class="text-yellow-600 hover:text-yellow-900" onclick="editarProyecto(<?php echo e($proyecto->ProyectoID); ?>)">Editar</button>
                                            <button class="text-red-600 hover:text-red-900" onclick="eliminarProyecto(<?php echo e($proyecto->ProyectoID); ?>)">Eliminar</button>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
    ...
    <div id="modalNuevoProyecto" class="fixed inset-0 bg-black bg-opacity-50 hidden overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-0 border-0 w-11/12 md:w-3/4 lg:w-1/2 shadow-2xl rounded-xl bg-white overflow-hidden">
            ...
            <form id="formNuevoProyecto" action="<?php echo e(route('admin.presidente.proyectos.store')); ?>" method="POST" class="p-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select name="ResponsableID"
                            ...
                            <?php $__currentLoopData = $miembros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $miembro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($miembro->MiembroID); ?>"><?php echo e($miembro->Nombre); ?></option>
...
<?php echo $__env->make('layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Carlo\Desktop\Club Rotaract-Web Service\Rotaract_Diseño_Web\Rotaract\rotaract\resources\views/modulos/admin/presidente/estado-proyectos.blade.php ENDPATH**/ ?>